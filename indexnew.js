(function () {
    ...
    // This provides a way to determine the name of a functiion constructor in a generic way...
    ...
    var ProtoLib = function (handle) {
        ...
        /**
         * A stack, where the last item in the array is the current 'this' value being used by the library functions.
         * This is more efficient than using 'bind' as the library functions as invoked.
         * @type {Array}
         */
        thisPointerStack = [],
