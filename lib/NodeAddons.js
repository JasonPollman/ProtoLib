...
module.exports = function (JLib) {
    ...
    //  * @type {JPCConsole}
    //  */
    // JLib.console = new JLib.Console(JLib.ARGS);
    //
    // /**
    //  * A JPDebugger instance, for general purpose use.
    //  * @type {JPDebugger}
    //  */
    // JLib.Debug = require('jpc-debugger');
    //
    // /**
    //  * A shortcut for the debugger client
    //  * @type {JPDebuggerClient}
    //  */
    // JLib.DebugClient = JLib.debug = JLib.Debug.Client;
    //
    // // If the --debug argument is passed in via command line, start up an all-purpose client debugger instance...
    // if(JLib.DEBUG) JLib.debugger = new JLib.DebugClient(); else JLib.debugger = JLib.Debug.FakeClient;
     ...
     * @function
     */
    JLib.string.hash = function hash (algorithm) {
     ...
     * @function
     */
    JLib.string.wordWrapForTTY = function wordWrapForTTY (padleft, padright, omitFirst) {
        JLib.performWithCurrent(function (s) {
     ...
     * @function
     */
    JLib.object.hash = function hash (algorithm) {
     ...
     * @function
     */
    JLib.object.bytes = function bytes () {
        JLib.performWithCurrent(function (o) {
    ...
    JLib.getProcessPathByPID = function getProcessPathByPID (pid, done) {
        done = arguments[JLib.PROTO_IDENTIFIER].last() instanceof Function ? arguments[JLib.PROTO_IDENTIFIER].last() : exports.NULLF;
        var e;
    ...
    JLib.parseJPCConfigFile = function parseJPCConfigFile (source, user) {
        ...
        if(typeof user === 'object') user[JLib.PROTO_IDENTIFIER].each((u, k) => { options[k] = u; });
        return options;
    };
};
