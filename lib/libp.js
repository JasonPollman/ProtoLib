    ...
    function libp (libs, getThisValueAndInvoke) {
        var libp = {
            ...
            array: {
                ...
                differenctFromArray: function differenctFromArray () {
                    return getThisValueAndInvoke(function (a) {
                        return libs.array.differenctFromArray(a);
                    });
                },

                intersectArray: function intersectArray () {
                    var args = libs.object.makeArray(arguments);
                    return getThisValueAndInvoke(function (a) {
                        args.unshift(a);
                        return libs.array.intersectArray.apply(a, args);
                    });
                },
            ...
            object: {
                ...
                toInteger: function toInteger () {
                    return getThisValueAndInvoke(function (o) {
                        return libs.object.toInteger(o);
                    });
                },

                makeArray: function makeArray () {
                    return getThisValueAndInvoke(function (o) {
                        return libs.object.makeArray(o);
                    });
                },
